      ...
      : addCase(
          {
            ...
            filing: {
              ...values.filing,
              judgeId:
                values.filing.judgeId === "" ? null : values.filing.judgeId,
              stageId:
                values.filing.stageId === "" ? null : values.filing.stageId,
            },
          },
          () => {}
        );
      ...
      initialValues={
        params.id
          ? {
              ...caseDetailById?.data,
              caseTypeId:
                caseDetailById?.data?.caseTypeId === null
                  ? ""
                  : caseDetailById?.data?.caseTypeId,
              caseCategoryId:
                caseDetailById?.data?.caseCategoryId === null
                  ? ""
                  : caseDetailById?.data?.caseCategoryId,
              filing: {
                ...caseDetailById?.data?.filing,
                stageId:
                  caseDetailById?.data?.filing.stageId === null
                    ? ""
                    : caseDetailById?.data?.filing.stageId,
                judgeId:
                  caseDetailById?.data?.filing.judgeId === null
                    ? ""
                    : caseDetailById?.data?.filing.judgeId,
                judge: {
                  ...caseDetailById?.data?.filing.judge,
                  districtId:
                    caseDetailById?.data?.filing?.judge?.districtId === null
                      ? ""
                      : caseDetailById?.data?.filing?.judge?.districtId,
                  talukaId:
                    caseDetailById?.data?.filing?.judge?.talukaId === null
                      ? ""
                      : caseDetailById?.data?.filing?.judge?.talukaId,
                },
              },
            }
          : initialValues
          ...
          <Form className="form">
            ...
            <div>
              {stepper?.map((step: any, i: any) => {
                return (
                  // <div
                  //   className="accordion-item shadow-sm card mb-5 mb-xl-10"
                  //   key={i}
                  // >
                  <div className="" key={i}>
                    {/* <h2
                    ...
                    {/* <button
                      ...
                      > */}
                    <div className="btn bg-light-primary rounded-circle fs-3 me-4 text-primary">
                      {i + 1}{" "}
                    </div>
                    {step}
                    {/* </button> */}
                      ...
                      <div className="card-body border-top p-9">
                        {step === "Account Details" && (
                          <>
                            <div className="row mb-lg-6">
                              ...
                              <div className="col-lg-6">
                                ...
                                <Field
                                  ...
                                  disabled={
                                    bankOfficerList?.data ? false : true
                                  }
                                >
                                  <option value={""} disabled>
                                    Select Bank Officer
                                  </option>
                                  {!bankOfficerList?.data?.length && (
                                    <option>{NO_RECORDS_FOUND}</option>
                                  )}
                                  {bankOfficerList?.data?.map(
                                    (list: any, i: any) => (
                                      <>
                                  ...
                                  <div className="row justify-content-start">
                                    {values?.borrowers?.map(
                                      (detail: any, index: any) => (
                                        <div
                                          className="mb-2 col-lg-4 row flex-nowrap align-items-center"
                                          key={index}
                                        >
                                          <div
                                            className="col-11 pe-0"
                                            key={index}
                                          >
                                            <div className="">
                                              <Field
                            ...
                            <div
                              className={`${!isMobile ? "border" : ""}p-4 mt-6`}
                            >
                              <FieldArray
                                name={`caseProducts`}
                                render={({ insert, remove, push }) => (
                                        ...
                                        >
                                          ...
                                          <div className="col-lg-4">
                                            ...
                                            <Field
                                              ...
                                              onChange={(e: any) => {
                                                setFieldValue(
                                                  `caseProducts.${index}.bankId`,
                                                  e.target.value
                                                );
                                                setFieldValue(
                                                  `caseProducts.${index}.productId`,
                                                  ""
                                                );
                                              }}
                                            >
                              ...
                              <>
                                {values?.properties?.map(
                                  (details: any, index: any) => (
                                    <div
                                      className="p-4 border position-relative mb-4"
                                      key={index}
                                    >
                                      <div className="row">
                                        <div className="col-lg-6">
                                          <label
                                            className=" col-form-label fw-bold fs-6 required pb-1"
                                            htmlFor={`properties.${index}.districtId`}
                                          >
                                            District Name
                                          </label>
                                          <div className="">
                                            <Field
                                              ...
                                              onChange={(e: any) => {
                                                setFieldValue(
                                                  `properties.${index}.districtId`,
                                                  e.target.value
                                                );
                                                setFieldValue(
                                                  `properties.${index}.talukaId`,
                                                  ""
                                                );
                                              }}
                                            >
                                        ...
                                        <div className="col-lg-6">
                                          <label
                                            className=" col-form-label fw-bold fs-6 required pb-1"
                                            htmlFor={`properties.${index}.talukaId`}
                                          >
                                            Taluka Name
                                          </label>
                                          <div className="">
                                      ...
                                      <div className="row">
                                        <div className="col-lg-6">
                                          <label
                                            htmlFor={`properties.${index}.location`}
                                            className="col-form-label fw-bold fs-6 required pb-1"
                                          >
                                            Location
                                          </label>
                                        ...
                                        <div className="col-lg-6">
                                          <label
                                            htmlFor={`properties.${index}.owner`}
                                            className="col-form-label fw-bold fs-6 required pb-1"
                                          >
                                            Owner
                                          </label>
                        ...
                        {step === "Court Details" && (
                          <>
                            <div className="d-flex mb-lg-6">
                              <label
                                htmlFor={`isFilled`}
                                className="col-form-label fw-bold fs-6 required me-4"
                              >
                                Filed
                              </label>
                              ...
                              <>
                                {/* <div className="row mb-lg-6">
                                  <div className="col-lg-6">
                                    ...
                                    <div className="">
                                      ...
                                      >
                                        ...
                                        {!caseCatList?.data?.length && (
                                          <option>{NO_RECORDS_FOUND}</option>
                                        )}
                                        {caseCatList?.data?.map(
                                          (list: any, i: any) => (
                                            <>
                                              {!params.id &&
                                                list.isActive === true && (
                                  ...
                                  <div className="col-lg-6">
                                    ...
                                    <Field
                                      ...
                                      disabled={
                                        caseTypeList?.data ? false : true
                                      }
                                    >
                                      <option value={""} disabled>
                                        Select Case Type
                                      </option>
                                      {!caseTypeList?.data?.length && (
                                        <option>{NO_RECORDS_FOUND}</option>
                                      )}
                                      {caseTypeList?.data?.map(
                                        (list: any, i: any) => (
                                          <>
                                            {!params.id &&
                                              list.isActive === true && (
                                ...
                                <div className="row mb-lg-6">
                                  <div className="col-lg-4">
                                    <label
                                      className=" col-form-label fw-bold fs-6 required"
                                      htmlFor={`filing.judge.districtId`}
                                    >
                                      District Name
                                    </label>
                                    <div className="">
                                      <Field
                                        ...
                                        onChange={(e: any) => {
                                          setFieldValue(
                                            `filing.judge.districtId`,
                                            e.target.value
                                          );
                                          setFieldValue(
                                            `filing.judge.talukaId`,
                                            ""
                                          );
                                        }}
                                      >
                                  ...
                                  <div className="col-lg-4">
                                    ...
                                    <div className="">
                                      <Field
                                        ...
                                        disabled={
                                          judgeList?.data ? false : true
                                        }
                                      >
                                        <option value="" disabled>
                                          Select Judge
                                        </option>
                                        {!judgeList?.data?.length && (
                                          <option>{NO_RECORDS_FOUND}</option>
                                        )}
                                        {judgeList?.data?.map(
                                          (list: any, i: any) => {
                                  ...
                                  <div className="col-lg-6">
                                    ...
                                    <div className="">
                                      ...
                                      >
                                        ...
                                        {!stageList?.data?.length && (
                                          <option>{NO_RECORDS_FOUND}</option>
                                        )}
                                        {stageList?.data?.map(
                                          (list: any, i: any) => (
                                            console.log(
                                              values.filing.stageId === null
                                            ),
                                            (
                                              <option key={i} value={list.id}>
                                                {list.name}
