            ...
            <div className="row mb-6">
              ...
              <div className="col-lg-8 fv-row fv-plugins-icon-container">
                <select
                  ...
                  data-select2-id="select2-data-10-bt7k"
                  tabIndex={-1}
                  aria-hidden="true"
                  data-kt-initialized="1"
                >
                  <option value="" data-select2-id="select2-data-12-41md">
                    Select a Country...
                  </option>
            ...
            <div className="row mb-6">
              ...
              <div className="col-lg-8 fv-row fv-plugins-icon-container">
                <select
                  ...
                  data-select2-id="select2-data-13-rm9t"
                  tabIndex={-1}
                  aria-hidden="true"
                  data-kt-initialized="1"
                >
                  <option value="" data-select2-id="select2-data-15-fi6q">
                    Select a Language...
                  </option>
                  <option data-kt-flag="flags/indonesia.svg" value="id">
            ...
            <div className="row mb-6">
              ...
              <div className="col-lg-8 fv-row fv-plugins-icon-container">
                <select
                  ...
                  className="form-select form-select-solid form-select-lg select2-hidden-accessible"
                  data-select2-id="select2-data-16-roo2"
                  tabIndex={-1}
                  aria-hidden="true"
                  data-kt-initialized="1"
                >
                  <option value="" data-select2-id="select2-data-18-exfo">
                    Select a Timezone..
                  </option>
            ...
            <div className="row mb-6">
              ...
              <div className="col-lg-8 fv-row">
                <select
                  ...
                  className="form-select form-select-solid form-select-lg select2-hidden-accessible"
                  data-select2-id="select2-data-19-o6mg"
                  tabIndex={-1}
                  aria-hidden="true"
                  data-kt-initialized="1"
                >
                  <option value="" data-select2-id="select2-data-21-qnw9">
                    Select a currency..
                  </option>
